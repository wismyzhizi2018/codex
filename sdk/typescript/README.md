...
The TypeScript SDK wraps the `codex` CLI from `@cc-claw/codex`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @cc-claw/codex-sdk
```
...
```typescript
import { Codex } from "@cc-claw/codex-sdk";
